...
public class AddMetaActionExample {
    public static void main(String[] args) {
        ...
        try {
            AddMetaAction actionForDomainToken = AddMetaAction.ofDomainToken(
                    "t2", "test1122", "logo2", "feitesting1", AuthorizerRef.createAccount(PublicKey.of(
                            "EVT6Qz3wuRjyN6gaU3P3XRxpnEZnM4oPxortemaWDwFRvsv2FxgND"))
            );

            AddMetaAction actionForGroup = AddMetaAction.ofDomainToken(
                    "t2", "test1122", "logo3", "feitesting1", AuthorizerRef.createAccount(PublicKey.of(
                            "EVT6Qz3wuRjyN6gaU3P3XRxpnEZnM4oPxortemaWDwFRvsv2FxgND"))
            );

            AddMetaAction actionForFungible = AddMetaAction.ofFungible(
                    "20", "logo4", "feitesting1", AuthorizerRef.createAccount(PublicKey.of(
                            "EVT6Qz3wuRjyN6gaU3P3XRxpnEZnM4oPxortemaWDwFRvsv2FxgND"))
            );
