...
public class ApproveSuspendExample {
    public static void main(String[] args) {
        ...
        try {
            List<Signature> signatures = transactionService.getSignaturesByProposalName(keyProvider, "testProposal12");

            ApproveSuspendAction action = ApproveSuspendAction.of("testProposal12",
